  ...
  return (
    <div className="py-1 bg-zinc-900">
      <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-24">
        <div className="relative flex flex-col min-w-0 break-words bg-zinc-800 w-full mb-6 shadow-lg rounded">
          <div className="rounded-t mb-0 px-4 py-3 border-0 flex flex-col gap-4">
            ...
            <div className="inline-flex rounded-md shadow-sm" role="group">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white  border-white border-t border-b border-l border-r  hover:bg-zinc-700"
              >
                ALL
              </button>
              <button
          ...
          <div className="block w-full  overflow-x-auto">
            <div className={loading ? "blur-sm" : ""}>
              <table className="items-center bg-transparent w-full min-h-[100vh] border-collapse">
                <thead>
                  <tr>
                ...
                <tbody>
                  {transactions?.map((tx) => (
                    <tr key={tx?.txHash} className="hover:bg-zinc-700">
                      ...
                      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-md whitespace-nowrap p-4">
                        {tx?.txType === "DEPLOY_ACCOUNT" ? (
                          <span className="inline-flex items-center rounded-md bg-blue-200 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">
                            {tx?.txType}
                          </span>
                        ) : (
